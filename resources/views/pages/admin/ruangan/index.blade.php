                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="nama_ruang"
                                                                    id="nama_ruang" placeholder="nama_ruang" required>
                                                            </div>
                                                            {{-- <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_ruang" id="nama_ruang"
                                        placeholder="nama_ruang" required>
                                </div>
                                {{-- <div class="form-group">
                                    <label for="exampleInputFile">Cover</label>
                                    <div class="input-group">
    ...
    <script>
        $(document).ready(function() {
                    ...
                    // },
                    {
                        ...
                        render: function(data) {
                            return '<div class="row justify-content-center">' +
                                ...
                                ' data-target="#modal-edit" data-id="' + data.id_ruang +
                                '" data-nama_ruang="' + data.nama_ruang +
            ...
            $('#modal-edit').on('show.bs.modal', function(event) {
                ...
                var id_ruang = button.data('id');
                var nama_ruang = button.data('nama_ruang');
                // var sks = button.data('sks');
                // var semester = button.data('semester');
                var modal = $(this);

                modal.find('.modal-body #id_ruang').val(id_ruang);
                modal.find('.modal-body #nama_ruang').val(nama_ruang);

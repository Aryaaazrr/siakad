                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('golongan.store') }}" method="POST"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="nama_gol">nama_gol</label>
                                                                <input type="text" class="form-control" name="nama_gol"
                                                                    id="nama_gol" placeholder="nama_gol" required>
                                                            </div>
                                                            {{-- <div class="form-group">
        ...
        <div class="modal fade" id="modal-edit">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('golongan.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="nama_gol">nama_gol</label>
                                    <input type="text" class="form-control" name="nama_gol" id="nama_gol"
                                        placeholder="nama_gol" required>
                                </div>
                                {{-- <div class="form-group">
                                    <label for="exampleInputFile">Cover</label>
                                    <div class="input-group">
    ...
    <script>
        $(document).ready(function() {
                    ...
                    // },
                    {
                        ...
                        render: function(data) {
                            return '<div class="row justify-content-center">' +
                                ...
                                ' data-target="#modal-edit" data-id="' + data.id_gol +
                                '" data-nama_gol="' + data.nama_gol +
                                ...
                                data.id_gol + '\')"' +
                                ' data-id="' + data.id_gol + '">Hapus</button>' +
                                '</div>' +
                                '</div>';
                        }
                    }
            ...
            $('#modal-edit').on('show.bs.modal', function(event) {
                ...
                var id_gol = button.data('id');
                var nama_gol = button.data('nama_gol');
                var modal = $(this);

                modal.find('.modal-body #id_gol').val(id_gol);
                modal.find('.modal-body #nama_gol').val(nama_gol);
            });
